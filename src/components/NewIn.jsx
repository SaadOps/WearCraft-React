  ...
  return (
    ...
    >
      <div className="row justify-content-center no-gutters ">
        <hr className=" hidden lg:block border-t-4 border-white my-4  " />
        <h1 className="text-4xl font-bold text-white text-center mb-4">
          New In
        </h1>
        <Card
          style={{ width: "16rem" }}
          className="mb-3 mr-10  px-0 bg-transparent text-white"
        >
          <Card.Img variant="top" src={New1} />
          <Card.Body className="bg-black">
            <Card.Title>Cotton jersey T-shirt</Card.Title>
            <Card.Text className="font-bold">Rs. 599</Card.Text>
